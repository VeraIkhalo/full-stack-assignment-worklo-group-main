...
import { ArrowRight, Shield, Crown, Loader2, UserPlus, Users } from 'lucide-react';
...
export default function AdminHubPage() {
  ...
  const features = [
    {
      title: 'Users',
      description: 'View, search, and soft-remove people in your organization.',
      icon: Users,
      href: '/admin/users',
      color: 'text-blue-600 bg-blue-500/10',
      show: isSuperadminUser || hasPermission(Permission.MANAGE_USERS),
    },
    {
