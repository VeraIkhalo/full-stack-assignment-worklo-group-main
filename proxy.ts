...
/**
 * Proxy - Security, Rate Limiting & Basic Route Protection
 *
 * Handles:
 ...
 * Runs on the Node.js runtime (Next.js 16 proxy convention).
 */
 ...
 * We only check for cookie presence, not validity (full auth is done in pages)
 */
...
export async function proxy(req: NextRequest) {
  ...
  // happen in the actual page components
  return res;
}
