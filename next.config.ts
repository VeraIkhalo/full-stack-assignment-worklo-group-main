...
const nextConfig: NextConfig = {
  ...
  // Custom webpack config below is Windows-only and used via `next build --webpack`.
  turbopack: {},
  ...
  // Skip type checking during build (already verified in CI/dev)
  // This cuts build time in half on low-memory VPS machines
  // Note: eslint.ignoreDuringBuilds was removed in Next.js 16 — lint via `npm run lint`
  typescript: {
